  ...
  return (
    <div  className="flex flex-col justify-center items-center h-screen align-middle">
      ...
      <div className="flex flex-col sm:flex-row">
        <div className="flex-1 flex justify-center md:justify-end p-2 sm:p-10">
          <Image
            width={500}
            height={500}
            objectFit="cover"
        ...
        <div className={classNames("flex flex-col justify-center p-2 sm:p-10 flex-1", classModule('text-intro'))}>
